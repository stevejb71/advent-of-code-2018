...
favouriteSleepMinute :: [SleepPeriod] -> Int
favouriteSleepMinute sleepPeriods = head $ maxBy length $ groupBy (==) $ sort $ concatMap sleepMinutes sleepPeriods
...
main = do
    ...
    let longestSleepGuard = findLongestSleeper guardSleepPeriods
    let sleepPeriodsOfLongestSleepingGuard = guardSleepPeriods ! longestSleepGuard
    let favMin = favouriteSleepMinute sleepPeriodsOfLongestSleepingGuard
    print $ longestSleepGuard * favMin
